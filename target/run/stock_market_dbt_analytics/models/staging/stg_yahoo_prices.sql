  ...
  create or replace view `dbt-demo-project-485817`.`dbt_dev`.`stg_yahoo_prices`
  OPTIONS()
  as -- FUTURES-SPECIFIC HANDLING:
...
with source as (
    ...
    select * from `dbt-demo-project-485817`.`raw_yahoo`.`raw_yahoo_prices`
